<template>
     <div class="mx-6 pa-0 my-6 cardStyle" >
      ...
      line-height: 20px;">
            ...
            <v-chip v-if="dataselect.status == 3" size="small" rounded="lg" color="mygreen">
            <span style="
      font-size: 12px!important;
      font-weight: 600;
      line-height: 20px;">
...
font-style: normal;
font-weight: 500;
line-height: normal; " class="d-flex align-center">ID25725728RS <v-icon size="x-small" color="mygreen" class="ml-2" icon="mdi mdi-content-copy"></v-icon></p>
        </v-col>
        <v-col >
          <p 
          class="mb-2"
...
line-height: normal; " class="d-flex align-center">May 24</p>
        ...
        <v-col style="position: relative;">
          <v-icon style="    top: -28px;
    left: 2%;position: absolute;" color="mygreen" icon="mdi mdi-check-circle"></v-icon>
          <p 
          class="mb-2"
          style="color:  #969696;
font-size: 14px;
