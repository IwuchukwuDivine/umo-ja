<template>
    <div>
        ...
        <v-container   class="py-0">
            ...
            <v-btn @click="opendialog()" flat size="large" color="mygreen rounded-xl" >
  ...
  <div class="py-8">
    <v-btn @click="opendialog()"  color="mygreen" flat class="mx-auto" size="x-large" rounded="xl">Join the Waitlist</v-btn>
  </div>
                </div>
            </v-container>
  ...
  <div class="alignc">
    ...
    <v-btn :loading="loading" @click="submitForm()" width="235" class="my-4" flat size="large" color="mygreen rounded-xl" >
        <span style="font-size: 14px;">
            Join the Waitlist
        </span>
    </v-btn>
  ...
  <v-btn width="215" color="#EDF0EF" flat rounded="xl" class="mt-4 mb-6"><v-icon size="15" color="mygreen" icon="mdi mdi-email-outline" class="mr-2"></v-icon> <span style="color: var(--magnetic-green-4, #2C6E63);
  text-align: center;
  font-size: 12px;
  font-weight: 400;
