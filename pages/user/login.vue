...
<v-form ref="form" @submit.prevent="handleLogin">
    <p class="inputLabel">Email Address</p>             
        ...
        <v-text-field v-model="email" :rules="emailRules"  prepend-inner-icon="mdi mdi-email-outline" placeholder="Enter email address" density="comfortable"  >
        </v-text-field>

        <p class="inputLabel">Password</p>             
    <v-text-field v-model="password" :rules="passwordRules"  prepend-inner-icon="mdi mdi-lock-outline" append-inner-icon="mdi mdi-eye-outline" placeholder="Enter Password" density="comfortable"  >
        </v-text-field>  
    <v-row>
    <v-col cols="6" class="py-0">
        <v-checkbox color="mygreen">
    ...
    <p v-if="userStore.loginError" style="color: red;">{{ userStore.loginError }}</p>
        <v-btn type="submit" block color="mygreen" flat size="x-large" class="rounded-lg mt-3"> 
            <span>
...
Sign in
        ...
        <div class="d-flex py-5 justify-space-between align-center"><v-divider></v-divider>
            ...
            <div class="d-flex justify-space-between py-0 mb-4">
                <v-btn flat style="background-color: #ededed;" class="text-mygreen green-hover" width="30%" icon="mdi mdi-apple"></v-btn>
                <v-btn flat style="background-color: #ededed;" class="text-mygreen green-hover" width="30%" icon="mdi mdi-google"></v-btn>
                <v-btn flat style="background-color: #ededed;" class="text-mygreen green-hover" width="30%" icon="mdi mdi-facebook"></v-btn>
            </div>
